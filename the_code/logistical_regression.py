...
def opportunites():
    ...
    title='Logistic Regression on the Opportunities for professional development Variable against Leaver'))
    print()
...
def IncreseSalaryProfDevelopment(): # Good to go
    ...
    title='Logistical Regression on the pay rewards increase of completing professional development variable against Leaver'))
    print()
...
def regressFreeTraining():
    ...
    title='Logistical Regression on the Free Traininng Variable against Leaver'))
    print()
...
def age(): 
    ...
    title='Logistical Regression on the Age Variable against Leaver'))
    print()
...
def freeLunch(): 
    ...
    title='Logistical Regression on the Free Lunch Variable against Leaver'))
    print()
...
def regressMulti3():
    ...
    print(model.summary(yname="Status Leaver", 
    title=' Multiple Logistical Regression on F0119, T0186, and S1628 '))
    print()
...
def regressMulti4():
    ...
    print(model.summary(yname="Status Leaver", 
    title=' Multiple Logistical Regression on F0119, T0186, S1628, and AGE_T_x '))
    print()
...
def regressMulti5():
    ...
    print(model.summary(yname="Status Leaver", 
    title=' Multiple Logistical Regression on F0119, T0186, S1628, AGE_T_x, S0287 '))
    print()
    print()
...
def regressMulti6():
    ...
    print(model.summary(yname="Status Leaver", 
    title=' Multiple Logistical Regression on F0119, T0186, S1628, AGE_T_x, S0287, T0178'))
    print()
    print()
