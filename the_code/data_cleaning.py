...
df['S0287'] = df['S0287'].replace([-8, -9], np.nan) #Free Lunch
...
df['F0119'] = df['F0119'].replace([1,2,3,4,5,-8], [1,1,np.nan,0,0,np.nan])
df['F0607'] = df['F0607'].replace([1,2,3,4,5], [1,1,np.nan,0,0]) # Not merging correctly.
df['F0608'] = df['F0608'].replace([1,2,3,4,5], [1,1,np.nan,0,0])
...
'F0607', 'F0120', 'F0608', 'F0603','F0115','T0165', 'T0178', 'T0179', 'T0186',]]
...
# df['F0119'] = df['F0119'].replace(-8, np.nan)  
# df['F0115'] = df['F0115'].replace(-8, np.nan) 
# df['F0744'] = df['F0744'].replace(-8, np.nan) 
