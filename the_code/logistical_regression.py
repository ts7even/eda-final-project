...
def IncreseSalaryProfDevelopment(): 
    ...
    print(pre_stats)
    print()
    model = smf.logit('NEW_STATUS ~ C(T0186)', data = df1).fit()
    ...
    print(pre_stats)
    print()
    model = smf.logit('NEW_STATUS ~ C(T0186)', data = df2).fit()
...
def regressFreeTraining():
    ...
    print(pre_stats)
    print()
    model = smf.logit('NEW_STATUS ~ C(S1628)', data = df1).fit()
    ...
    print(pre_stats)
    print()
    model = smf.logit('NEW_STATUS ~ C(S1628)', data = df2).fit()
...
def usefullDevelopment():
    ...
    print(pre_stats)
    print()
    model = smf.logit('NEW_STATUS ~ C(T0178)', data = df).fit()
    ...
    print(pre_stats)
    print()
    model = smf.logit('NEW_STATUS ~ C(T0178)', data = df1).fit()
    ...
    print(pre_stats)
    print()
    model = smf.logit('NEW_STATUS ~ C(T0178)', data = df2).fit()
...
def age(): 
    ...
    print(pre_stats)
    print('\n \n')
    model = smf.logit('NEW_STATUS ~ C(AGE_T_x)', data = df).fit()
    ...
    print(pre_stats)
    print('\n \n')
    model = smf.logit('NEW_STATUS ~ C(AGE_T_x)', data = df1).fit()
    ...
    print(pre_stats)
    print('\n \n')
    model = smf.logit('NEW_STATUS ~ C(AGE_T_x)', data = df2).fit()
...
def freeLunch(): 
    ...
    print(pre_stats)
    print()
    model = smf.logit('NEW_STATUS ~ C(S0287)', data = df1).fit()
    ...
    print(pre_stats)
    print()
    model = smf.logit('NEW_STATUS ~ C(S0287)', data = df2).fit()
...
def mastersDegree():
    ...
    print(pre_stats)
    print()
    model = smf.logit('NEW_STATUS ~ C(T0080)', data = df).fit()
    ...
    print(pre_stats)
    print()
    model = smf.logit('NEW_STATUS ~ C(T0080)', data = df1).fit()
    ...
    print(pre_stats)
    print()
    model = smf.logit('NEW_STATUS ~ C(T0080)', data = df2).fit()
...
#     print(pre_stats)
#     print()
#     model = smf.logit('NEW_STATUS ~ C(F0603)', data = df).fit()
...
#     print(pre_stats)
#     print()
#     model = smf.logit('NEW_STATUS ~ C(F0603)', data = df1).fit()
...
#     print(pre_stats)
#     print()
#     model = smf.logit('NEW_STATUS ~ C(F0603)', data = df2).fit()
...
#     print(pre_stats)
#     print()
#     model = smf.logit('NEW_STATUS ~ C(F0115)', data = df).fit()
#     print(model.summary(yname="Status Leaver", xname=['Intercept', 'Disagree with coloboration with teachers (Overall)'], 
...
#     print(pre_stats)
#     print()
#     model = smf.logit('NEW_STATUS ~ C(F0115)', data = df1).fit()
#     print(model.summary(yname="Status Leaver", xname=['Intercept', 'Disagree with coloboration with teachers (Male)'], 
...
#     print(pre_stats)
#     print()
#     model = smf.logit('NEW_STATUS ~ C(F0115)', data = df2).fit()
#     print(model.summary(yname="Status Leaver", xname=['Intercept', 'Disagree with coloboration with teachers (Female)'], 
...
#     print(pre_stats)
#     print()
#     model = smf.logit('NEW_STATUS ~ C(F0121)', data = df).fit()
...
#     print(pre_stats)
#     print()
#     model = smf.logit('NEW_STATUS ~ C(F0121)', data = df1).fit()
...
#     print(pre_stats)
#     print()
#     model = smf.logit('NEW_STATUS ~ C(F0121)', data = df2).fit()
...
def teacherEarnings():
    ...
    print(pre_stats)
    print()
    model = smf.logit('NEW_STATUS ~ C(EARNALL)', data = df).fit()
    ...
    print(pre_stats)
    print()
    model = smf.logit('NEW_STATUS ~ C(EARNALL)', data = df1).fit()
    ...
    print(pre_stats)
    print()
    model = smf.logit('NEW_STATUS ~ C(EARNALL)', data = df2).fit()
